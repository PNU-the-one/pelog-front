...
export default class MyInfo extends Component {
  template() {
    return `
      <div id="myinfo">
        <div class="myprofile">
          <div data-component="MyProfile"></div>
          <div class="descriptionbox">
            <div class="name">MYEONG SEONG CHOE</div>
            <div class="description">나는 바보다.</div>
          </div>
        </div>

        <div class='myinfo-underline'></div>
  ...
  mounted() {
    const $myprofile = this.$target.querySelector("[data-component='MyProfile']");
